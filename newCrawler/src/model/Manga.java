...
public class Manga implements Serializable {
	...
	private static String ImgDefaultLink ="http://www.roncato.com/upload/rv_product/images/RoncatoLight_emozionale_BIG.png";
	...
	public void setLastDate(Double lastdate){this.lastdate = (lastdate * 1000);}
    ...
    public String toString() {
        return String.format("Manga[IDManga = %s, alias = %s, image = %s, title = %s, lastdate = %f, status = %d, hits = %d, ch_len = %d, lang = %d]", 
